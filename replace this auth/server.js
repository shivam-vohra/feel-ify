...
const client_id = '3ebaced21096427090115826ab5a94e5'; // Insert your client ID here
const client_secret = '38e9784f35984a359ae2b901543d92b4'; // Insert your client secret here
const redirect_uri = 'http://localhost:8000/callback'; // Your redirect URI
const scopes = 'streaming user-read-email'; // Define your scopes here
...
app.get('/callback', async (req, res) => {
  ...
  if (code) {
    try {
      ...
      res.send('Access token received, check the server console log.');
